...
namespace EventOrganizer.Migrations
{
    ...
    [Migration("20190418165502_CartItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventOrganizer.Data.Models.EventsCartItem", b =>
                {
                    b.Property<int>("EventsCartItemId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("EventId");

                    b.Property<string>("EventsCartId");

                    b.HasKey("EventsCartItemId");
            ...
            modelBuilder.Entity("EventOrganizer.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("EventOrganizer.Data.Models.EventsCartItem", b =>
                {
                    b.HasOne("EventOrganizer.Data.Models.Event", "Event")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EventOrganizer.Data.Models.User")
                        .WithMany()
